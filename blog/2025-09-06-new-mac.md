...
<!-- truncate -->
<!-- cspell:word karabiner appswitcher pmset autohide bambu -->
...
9. [Magnet](https://apps.apple.com/us/app/magnet/id441258766?mt=12)
10. `brew install sox` (for the `play` command)
11. [VS Code](https://code.visualstudio.com/download)
12. [GitHub CLI](https://cli.github.com)
13. [Affinity Suite](https://affinity.serif.com)
14. [nvm](https://github.com/nvm-sh/nvm)
15. [Karabiner Elements](https://karabiner-elements.pqrs.org)
16. [Daisy Disk](https://apps.apple.com/us/app/daisydisk/id411643860?mt=12)
17. [Docker](https://docs.docker.com/desktop/setup/install/mac-install/)
18. [Autodesk Fusion](https://www.autodesk.com/products/fusion-360/personal)
19. [Bambu Studio](https://bambulab.com/en-us/download/studio)
20. [AWS CLI](https://docs.aws.amazon.com/cli/latest/userguide/getting-started-install.html)
...
13. Setup git.
    ...
    3. Fix branch order sort: `git config --global branch.sort -committerdate`
    4. Prevent auto branch tracking: `git config --global branch.autoSetupMerge false`
...
19. Copy Bambu Studio configs: `~/Library/Application Support/BambuStudio`
20. Globally disable npm install scripts: `npm config set ignore-scripts true`
